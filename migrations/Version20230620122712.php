...
final class Version20230620122712 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Initial setup of the schema.';
    }

    public function up(Schema $schema): void
    {
//        $this->skipIf(!$this->connection->getDatabasePlatform() instanceof PostgreSQLPlatform, "Not PGSQL");
